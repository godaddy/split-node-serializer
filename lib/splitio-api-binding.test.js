...
describe('lib.splitio-api-binding', () => {
  ...
  describe('getSegmentsInUse', () => {
    it('returns segments in use by splits', () => {
      ...
      const segments = getSegmentsInUse({ splitConditions })
      expect(segments.size).equals(1)
      expect(segments.has('test-segment')).equals(true)
    })
  })
})
