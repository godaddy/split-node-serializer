...
describe('lib.data-serializer.DataSerializer', () => {
  describe('generateSerializedDataScript', () => {
    ...
    it('returns script with cached serializedData when there is a splits argument and empty serializedDataSubsets', () => {
      const dataSerializer = new DataSerializer({
        poller: {
          cache: {
            serializedData: '{"splitsData":{"split-1-name":"{\\"name\\":\\"split-1-name\\",\\"status\\":\\"bar\\"}","split-2-name":"{\\"name\\":\\"split-2-name\\",\\"status\\":\\"baz\\"}"},"since":1,"segmentsData":{"test-segment":"{\\"name\\":\\"test-segment\\",\\"added\\":[\\"foo\\",\\"bar\\"]}"},"usingSegmentsCount":2}',
          ...
          generateSerializedData: () => '{"splitsData":{"split-1-name":"{\\"name\\":\\"split-1-name\\",\\"status\\":\\"bar\\"}"},"since":1,"segmentsData":{"test-segment":"{\\"name\\":\\"test-segment\\",\\"added\\":[\\"foo\\",\\"bar\\"]}"},"usingSegmentsCount":2}'
        }
      })
    ...
    it('returns script with cached serializedData when there is a splits argument and filled serializedDataSubsets', () => {
      const dataSerializer = new DataSerializer({
        poller: {
          cache: {
            serializedData: '{"splitsData":{"split-1-name":"{\\"name\\":\\"split-1-name\\",\\"status\\":\\"bar\\"}","split-2-name":"{\\"name\\":\\"split-2-name\\",\\"status\\":\\"baz\\"}"},"since":1,"segmentsData":{"test-segment":"{\\"name\\":\\"test-segment\\",\\"added\\":[\\"foo\\",\\"bar\\"]}"},"usingSegmentsCount":2}',
            serializedDataSubsets: { 'split-1-name': '{"splitsData":{"split-1-name":"{\\"name\\":\\"split-1-name\\",\\"status\\":\\"bar\\"}"},"since":1,"segmentsData":{"test-segment":"{\\"name\\":\\"test-segment\\",\\"added\\":[\\"foo\\",\\"bar\\"]}"},"usingSegmentsCount":2}' }
          }
        }
      })
      const res = dataSerializer.generateSerializedDataScript(['split-1-name'])
